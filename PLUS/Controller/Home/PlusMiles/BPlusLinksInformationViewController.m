//
//  BPlusLinksInformationViewController.m
//  PLUS
//
...
#import "Constants.h"
@interface BPlusLinksInformationViewController ()

@end

@implementation BPlusLinksInformationViewController
...
- (void)createUI {
    ...
    NSString* url = @"http://www.plusmiles.com.my";
